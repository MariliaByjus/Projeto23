...
var plane , block1 , block2 , rotator1 , rotator2 , rotator3 , particle1 , particle2, particle3;	
var particle4 , particle5, particle6 , particle7;
var angle2 = 90;
var angle3 = 70;
var angle = 60;
...
particle2 = Bodies.circle(220,10,10,particule_options);
World.add(world,particle2);

particle3 = Bodies.circle(220,10,10,particule_options);
World.add(world,particle3);

particle4 = Bodies.circle(220,10,10,particule_options);
World.add(world,particle4);

particle5 = Bodies.circle(220,10,10,particule_options);
World.add(world,particle5);

particle6 = Bodies.circle(220,10,10,particule_options);
World.add(world,particle6);

particle7 = Bodies.circle(220,10,10,particule_options);
